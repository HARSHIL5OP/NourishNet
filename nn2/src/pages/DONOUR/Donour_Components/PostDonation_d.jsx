...
const PostDonation_d = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 z-5">
      <div className="bg-white shadow-lg rounded-lg flex overflow-hidden" style={{ width: '900px' }}>
        ...
        <div className="w-1/2 relative">
          <img
            // src="https://beyondonor.com/wp-content/uploads/2024/01/food-packet-scaled.jpeg"
            src={poor}
