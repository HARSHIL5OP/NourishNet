    ...
    <div className="text-gray-800 z-5">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row items-center w-full">
            <div className="w-full md:w-61/100">
              ...
              <a href="#donate-now" className="bg-green-500 text-white px-6 py-3 rounded-full font-medium hover:bg-green-600">
                Donate Now
              </a>
            </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container mx-auto px-6 text-center">
          ...
          <a href="" className="bg-green-500 text-white px-6 py-3 rounded-full font-medium hover:bg-green-600" onClick={()=>navigate('/home_d/postDonation_d')}>
            Get Started
          </a>
        </div>
      </section>
